...
function help(arg) {
    ...
    var commands = {
        ...
        "list_cookies":{"description":"lists currently stored cookies","argument":"","example":"list_cookies()"},
        "raw_json":{"description":"shows the json text for an object","argument":"object","example":"raw_json(text)"},
        ...
        "text":{"description":"simply returns the argument as text","argument":"text","example":"text(text here)"},
        "factor":{"description":"returns an array of the prime factors of the argument","argument":"number","example":"factor(10)"},
        "function":{"description":"returns an executable function","argument":"function as text","example":"function(echo\(hello world\))"},
        "execute":{"description":"runs an executable function","argument":"function","example":"execute(function(echo\(hello world\)))"},
        "equals":{"description":"tests if two objects are identical","argument":"object,object","example":"equals(1,1)"},
        "if":{"description":"returns an output depending on a condition (boolean)","argument":"boolean,output if true,output if false","example":"if(equals(1,1),condition is true,condition is false)"},
        "select":{"description":"select an object from an array or labeled_array","argument":"index,array","example":"select(1,echo(zero,one,two))"},
        "array":{"description":"encloses argument in an array","argument":"object","example":"array(text)"},
        "data":{"description":"returns a data set","argument":"array,array,...","example":"data(echo(1,2),echo(2,3),echo(4,5))"},
        "labeled_array":{"description":"returns a labeled array with the specified fields","argument":"field name1,value1,field name2,value2,...","example":"labeled_array(first,myfirstobject,second,mysecondobject)"},
        "true":{"description":"boolean true value","argument":"","example":"true()"},
        "false":{"description":"boolean false value","argument":"","example":"false()"},
        "meta":{"description":"add a property and value to an object","argument":"property name,value,object","example":"meta(plain_text(linebreaks),true(),labeled_array(first,myfirstobject,second,mysecondobject))"},
        "plain_text":{"description":"returns non-json plain text string value","argument":"text","example":"plain_text(text)"},
        "echo":{"description":"returns argument","argument":"object","example":"echo(hello world)"},
